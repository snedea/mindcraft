/**
 * Bot Orchestration Commands
 *
 * These commands provide bot lifecycle management, resource mapping,
 * and survival milestone orchestration.
 *
 * Background: Originally developed for MCP server integration, but that
 * approach didn't work. This implements direct bot orchestration that
 * works with the mineflayer-based bot system.
 */
    ...
    // === SURVIVAL MILESTONE ORCHESTRATION ===
    {
        ...
        perform: async function(agent, milestoneName) {
            ...
            try {
                ...
                console.error('[Orchestration] Survival orchestration error:', error);
    ...
    // === BOT LIFECYCLE MANAGEMENT ===
    {
        ...
        perform: function(agent, botName) {
            try {
                ...
                // Destroy the agent
                console.log(`[Orchestration] Killing bot: ${botName}`);
            ...
            try {
                ...
                for (const botName of botNames) {
                    try {
                        ...
                        console.error(`[Orchestration] Error killing ${botName}:`, err);
                    }
                }
